                ...
                <div className="p-10 max-w-7xl mx-auto">
                    <div className="bg-white rounded-[40px] shadow-sm border border-slate-200 p-12">
                        ...
                        <form className="space-y-16">
                            ...
                            <section>
                                ...
                                <div className="space-y-4">
                                    {billItems.map((item, idx) => (
                                        <div key={idx} className="grid grid-cols-[1fr_150px_60px] gap-6 animate-in slide-in-from-right-4 duration-300" style={{ animationDelay: `${idx * 50}ms` }}>
                            ...
                            <section className="bg-slate-50 p-10 rounded-[40px] border border-slate-200 shadow-inner">
                            ...
                            <div className="flex gap-6 justify-end pt-10 border-t border-slate-100 mt-12">
                                <button
                                    type="button"
                                    className="px-10 py-5 bg-white hover:bg-red-50 text-red-500 font-bold rounded-2xl transition-all text-xs uppercase tracking-[0.2em] border border-slate-200 hover:border-red-100"
                                    onClick={() => {
                                        setBillItems([{ product_id: '', quantity: 1 }]);
                                        setCustomerEmail('');
                                        setCashDenoms({ 1: 0, 2: 0, 5: 0, 10: 0, 20: 0, 50: 0, 100: 0, 500: 0 });
                                ...
                                <button
                                    type="button"
                                    className="px-16 py-5 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-2xl shadow-2xl shadow-blue-100 transform hover:-translate-y-1 active:translate-y-0 transition-all text-sm uppercase tracking-[0.3em] flex items-center gap-4 "
